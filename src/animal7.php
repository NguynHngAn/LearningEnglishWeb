...
<body>
    <div class="quiz-container">
      ...
      <img src="retrieve_images.php?id=11" alt="Image">
        <p class="question">Đâu là phát âm của con mèo "Cat"?</p>
      </div>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(false, 12)">/’pændə/</button>
        <button id="choice2" class="choice" onclick="checkAnswer(false, 4)">/fɑks/</button>
        <button id="choice3" class="choice" onclick="checkAnswer(false, 2)">/dɔg/</button>
        <button id="choice4" class="choice" onclick="checkAnswer(true, 18)">/kæt/</button>
    </div>
    
    <div id="nextPage" class="hidden">
      <p class="hidden" id="congratulations">You're correct. GREAT!</p>
      <a href="animal8.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
