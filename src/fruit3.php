...
<body>
    <div class="quiz-container">
      ...
      <p class="top-right-info">Câu 3/10</p>
      <br>
      <p class="question">Quả nào sau đây có tên là "Watermelon"</p>
      <div class="answers-container">
        ...
        <button id="choice2" class="choice" onclick="checkAnswer(false, 10)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=17" alt="Image">
            </div>
       
          </div>
        </button>
        <button id="choice3" class="choice" onclick="checkAnswer(true, 15)">
          <div class="answer-content">
            <div class="answer-image">
      ...
      <div id="nextPage" class="hidden">
        <a href="fruit4.php" id="nextButton" class="hidden next-button">Next</a>
      </div>
    </div>
