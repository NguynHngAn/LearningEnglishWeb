...
<body>
    <div class="quiz-container">
      ...
      <br>
      <p class="question">"/hɑrt/" là phát âm của con vật nào sau đây?</p>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(false, 18)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=11" alt="Image">
            </div>
            <div class="answer-text">Cat</div>
          </div>
        </button>
        <button id="choice2" class="choice" onclick="checkAnswer(true, 7)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=9" alt="Image">
            </div>
            <div class="answer-text">Hart</div>
          </div>
        </button>
        <button id="choice3" class="choice" onclick="checkAnswer(false, 4)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_image.php?id=23" alt="Image">
            </div>
            <div class="answer-text">Fox</div>
          </div>
        </button>
        <button id="choice4" class="choice" onclick="checkAnswer(false, 9)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=14" alt="Image">
            </div>
            <div class="answer-text">Lion</div>
          </div>
        </button>
      </div>
      <p id="congratulations" class="hidden">You're correct. GREAT!</p>
      <div id="nextPage" class="hidden">
        <a href="animal5.php" id="nextButton" class="hidden next-button">Next</a>
      </div>
    </div>
