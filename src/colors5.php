...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Màu trắng"</p>
    <div class="answers-container">
      ...
      <button id="choice2" class="choice" onclick="checkAnswer(true, 13)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_image.php?id=9" alt="Image">
          </div>
          <div class="answer-text">White</div>
        </div>
      </button>
    ...
    <div id="nextPage" class="hidden">
      <a href="colors6.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
