...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Màu xanh lam"</p>
    <div class="answers-container">
      ...
      <button id="choice2" class="choice" onclick="checkAnswer(true, 10)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice3" class="choice" onclick="checkAnswer(false, 11)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice4" class="choice" onclick="checkAnswer(false, 14)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="colors2.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
