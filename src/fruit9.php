...
<body>
  <div class="quiz-container">
    ...
    <p class="top-right-info">Câu 9/10</p>
    <div class="question">
    <img src="retrieve_images.php?id=12" alt="">
      <p class="question">Đâu là phát âm của quả nho"Grape"?</p>
    </div>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(true, 6)">/greɪp/</button>
      ...
      <button id="choice4" class="choice" onclick="checkAnswer(false, 22)">/’æpl/</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="fruit10.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
