...
<body>
    <div class="quiz-container">
      ...
      <br>
      <p class="question">Con vật nào sau đây có tên là "Gorilla"</p>
      <div class="answers-container">
        ...
        <button id="choice2" class="choice" onclick="checkAnswer(false, 3)">
          <div class="answer-content">
            <div class="answer-image">
        ...
        <button id="choice3" class="choice" onclick="checkAnswer(true, 5)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=8" alt="Image">
            </div>
      ...
      <div id="nextPage" class="hidden">
        <a href="animal4.php" id="nextButton" class="hidden next-button">Next</a>
      </div>
    </div>
