...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Một"</p>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(true, 4)">
    ...
    <div id="nextPage" class="hidden">
      <a href="count2.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
