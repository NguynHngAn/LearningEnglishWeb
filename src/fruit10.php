...
<body>
  <div class="quiz-container">
    ...
    <p class="top-right-info">Câu 10/10</p>
    <div class="question">
      <img src="retrieve_images.php?id=10" alt="">
      <p class="question">Quả này có tên gọi là gì??</p>
    </div>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(false, 20)">Banana</button>
      <button id="choice2" class="choice" onclick="checkAnswer(false, 11)">Orange</button>
      <button id="choice3" class="choice" onclick="checkAnswer(true, 8)">Kiwi fruit</button>
      <button id="choice4" class="choice" onclick="checkAnswer(false, 1)">Coconut</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="dashboard.php" id="nextButton" class="hidden next-button">Hoàn thành</a>
    </div>
  </div>
