...
<body>
    <div class="quiz-container">
      ...
      <p class="top-right-info">Câu 5/10</p>
      <div class="question">
      <img src="retrieve_image.php?id=21" alt="Image">
        <p class="question">Tên gọi của quả này là gì?</p>
      </div>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(false, 14)">Strawberry</button>
        <button id="choice2" class="choice" onclick="checkAnswer(false, 20)">Banana</button>
        <button id="choice3" class="choice" onclick="checkAnswer(false, 22)">Apple</button>
        <button id="choice4" class="choice" onclick="checkAnswer(true, 21)">Avocado</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="fruit6.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
