...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Năm"</p>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(true, 2)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_image.php?id=12" alt="Image">
          </div>
          <div class="answer-text">Five</div>
        </div>
      </button>
      <button id="choice2" class="choice" onclick="checkAnswer(false, 6)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice4" class="choice" onclick="checkAnswer(false, 4)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="count6.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
