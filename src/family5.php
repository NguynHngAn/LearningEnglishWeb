...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Em bé"</p>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(false, 17)">
      ...
      <button id="choice3" class="choice" onclick="checkAnswer(true, 15)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_image.php?id=2" alt="Image">
          </div>
          <div class="answer-text">Baby</div>
        </div>
      </button>
      <button id="choice4" class="choice" onclick="checkAnswer(false, 19)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="family6.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
