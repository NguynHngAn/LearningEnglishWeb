...
<body>
  <div class="quiz-container">
    ...
    <p class="top-right-info">Câu 7/10</p>
    <div class="question">
      <img src="retrieve_images.php?id=15" alt="">
      <p class="question">Đâu là phát âm của quả táo"Apple"?</p>
    </div>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(false, 8)">/’ki:wi:fru:t/</button>
      <button id="choice2" class="choice" onclick="checkAnswer(false, 21)">/¸ævə´ka:dou/</button>
      <button id="choice3" class="choice" onclick="checkAnswer(false, 10)">/´mæηgou/</button>
      <button id="choice4" class="choice" onclick="checkAnswer(true, 22)">/’æpl/</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="fruit8.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
