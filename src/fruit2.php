...
<body>
    <div class="quiz-container">
      ...
      <img src="retrieve_image.php?id=26" alt="Image">
        <p class="question">Quả phía trên có tên gọi là gì??</p>
      </div>
      <div class="answers-container">
        ...
        <button id="choice3" class="choice" onclick="checkAnswer(false, 6)">Grape</button>
        <button id="choice4" class="choice" onclick="checkAnswer(true, 1)">Coconut</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="fruit3.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
