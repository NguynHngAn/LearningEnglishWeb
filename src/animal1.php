...
<body>
    <div class="quiz-container">
      ...
      <br>
      <p class="question">Con nào dưới đây có tên gọi "Dog"?</p>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(true, 2)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_image.php?id=24" alt="Image">
            </div>
        ...
        <button id="choice3" class="choice" onclick="checkAnswer(false, 3)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=16" alt="Image">
        
          </div>
        </button>
        <button id="choice4" class="choice" onclick="checkAnswer(false, 12)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=13" alt="Image">
      ...
      <div id="nextPage" class="hidden">
        <a href="animal2.php" id="nextButton" class="hidden next-button">Next</a>
      </div>
    </div>
