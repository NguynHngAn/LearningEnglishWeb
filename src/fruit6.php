...
<body>
    <div class="quiz-container">
      ...
      <div class="question">
      <img src="retrieve_images.php?id=20" alt="">
      <p class="question">Tên tiếng Anh của quả Dâu tây là gì?</p>
      </div>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(true, 14)">Strawberry</button>
        <button id="choice2" class="choice" onclick="checkAnswer(false, 20)">Banana</button>
        <button id="choice3" class="choice" onclick="checkAnswer(false, 10)">Mango</button>
        <button id="choice4" class="choice" onclick="checkAnswer(false, 22)">Apple</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="fruit7.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
