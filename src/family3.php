...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Anh/Em trai"</p>
    <div class="answers-container">
      ...
      <button id="choice2" class="choice" onclick="checkAnswer(true, 16)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice4" class="choice" onclick="checkAnswer(false, 17)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="family4.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
