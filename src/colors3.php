...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Màu vàng"</p>
    <div class="answers-container">
      ...
      <button id="choice3" class="choice" onclick="checkAnswer(true, 14)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_image.php?id=10" alt="Image">
          </div>
          <div class="answer-text">Yellow</div>
        </div>
      </button>
      <button id="choice4" class="choice" onclick="checkAnswer(false, 10)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="colors4.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
