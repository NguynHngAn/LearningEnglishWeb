...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Màu xanh lá"</p>
    <div class="answers-container">
      ...
      <button id="choice2" class="choice" onclick="checkAnswer(false, 12)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice4" class="choice" onclick="checkAnswer(true, 11)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="colors5.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
