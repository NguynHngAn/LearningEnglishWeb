...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Hai"</p>
    <div class="answers-container">
      ...
      <button id="choice2" class="choice" onclick="checkAnswer(false, 5)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice3" class="choice" onclick="checkAnswer(true, 6)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice4" class="choice" onclick="checkAnswer(false, 3)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="count3.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
