...
<body>
    <div class="quiz-container">
      ...
      <img src="retrieve_image.php?id=23" alt="Image">
        <p class="question">Tên gọi của con vật này là gì?</p>
      </div>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(false, 9)">Lion</button>
        <button id="choice2" class="choice" onclick="checkAnswer(false, 18)">Cat</button>
        <button id="choice3" class="choice" onclick="checkAnswer(false, 2)">Dog</button>
        <button id="choice4" class="choice" onclick="checkAnswer(true, 4)">Fox</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="animal6.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
