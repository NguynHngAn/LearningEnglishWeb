...
<body>
  <div class="quiz-container">
    ...
    <p class="top-right-info">Câu 8/10</p>
    <br>
    <p class="question">"Mango" là quả nào dưới đây?</p>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(false, 20)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_image.php?id=25" alt="">
          </div>

      </button>
      <button id="choice2" class="choice" onclick="checkAnswer(false, 21)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_image.php?id=21" alt="">
          </div>
      </button>
      ...
      <button id="choice4" class="choice" onclick="checkAnswer(true, 10)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_images.php?id=17" alt="">
    ...
    <div id="nextPage" class="hidden">
      <a href="fruit9.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
