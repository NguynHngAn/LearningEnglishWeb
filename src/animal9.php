...
<body>
    <div class="quiz-container">
      ...
      <img src="retrieve_images.php?id=14" alt="Image">
        <p class="question">Đâu là phát âm của con sư tử "Lion"?</p>
      </div>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(true, 9)">/ˈlaɪ.ən/</button>
        <button id="choice2" class="choice" onclick="checkAnswer(false, 2)">/dɔg/</button>
        <button id="choice3" class="choice" onclick="checkAnswer(false, 18)">/kæt/</button>
        <button id="choice4" class="choice" onclick="checkAnswer(false, 4)">/fɑks/</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="animal10.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
