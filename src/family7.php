...
<body>
    <div class="container">
        ...
        <h1 class="question">Hãy nhập "Anh/Em trai"</h1>
        <input type="text" id="textInput" placeholder="Enter your answer" oninput="checkInput()">
        <p id="result"></p>
        <a id="nextPageLink" href="family8.php" id="nextButton" class="hidden next-button">Next</a>
        <!-- Hidden by default -->
    </div>
    ...
    <script>
        ...
        async function setAudioSource() {
            const response = await fetch('retrieve_file.php?id=16');
