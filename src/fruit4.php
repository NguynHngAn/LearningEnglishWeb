...
<body>
    <div class="quiz-container">
      <h1></h1>
      <p class="top-left-info">Trái cây</p>
      <p class="top-right-info">Câu 4/10</p>
      <br>
      <p class="question">"/ɒrɪndʒ/" là phát âm của quả nào sau đây?</p>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(false, 8)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=10" alt="Image">
            </div>
            <div class="answer-text">Kiwi fruit</div>
          </div>
        </button>
        <button id="choice2" class="choice" onclick="checkAnswer(true, 11)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_image.php?id=22" alt="Image">
            </div>
            <div class="answer-text">Orange</div>
          </div>
        </button>
        <button id="choice3" class="choice" onclick="checkAnswer(false, 15)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_image.php?id=27" alt="Image">
            </div>
            <div class="answer-text">Watermelon</div>
          </div>
        </button>
        <button id="choice4" class="choice" onclick="checkAnswer(false, 6)">
          <div class="answer-content">
            <div class="answer-image">
            <img src="retrieve_images.php?id=12" alt="Image">
            </div>
            <div class="answer-text">Grape</div>
          </div>
        </button>
      </div>
      <p id="congratulations" class="hidden">You're correct. GREAT!</p>
      <div id="nextPage" class="hidden">
        <a href="fruit5.php" id="nextButton" class="hidden next-button">Next</a>
      </div>
    </div>
