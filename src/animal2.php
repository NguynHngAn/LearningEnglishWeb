...
<body>
    <div class="quiz-container">
      ...
      <div class="question">
      <img src="retrieve_images.php?id=7" alt="Image">
        <p class="question">Con vật phía trên có tên gọi là gì??</p>
      </div>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(false, 4)">Fox</button>
        <button id="choice2" class="choice" onclick="checkAnswer(false, 9)">Lion</button>
        <button id="choice3" class="choice" onclick="checkAnswer(false, 13)">Puma</button>
        <button id="choice4" class="choice" onclick="checkAnswer(true, 19)">Bear</button>
    </div>
    ...
    <div id="nextPage" class="hidden">
      ...
      <a href="animal3.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
