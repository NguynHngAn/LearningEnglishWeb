...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Mẹ"</p>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(false, 16)">
      ...
      <button id="choice2" class="choice" onclick="checkAnswer(false, 17)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice3" class="choice" onclick="checkAnswer(true, 18)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="family3.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
