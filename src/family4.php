...
<body>
  <div class="quiz-container">
    ...
    <p class="question">Hãy chọn "Chị/Em trai"</p>
    <div class="answers-container">
      ...
      <button id="choice3" class="choice" onclick="checkAnswer(false, 16)">
        <div class="answer-content">
          <div class="answer-image">
    ...
    <div id="nextPage" class="hidden">
      <a href="family5.php" id="nextButton" class="hidden next-button">Tiếp theo</a>
    </div>
  </div>
  <script>
