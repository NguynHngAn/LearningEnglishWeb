...
<body>
    <div class="quiz-container">
      ...
      <img src="retrieve_images.php?id=9" alt="Image">
        <p class="question">Con vật này có tên tiếng Anh là gì??</p>
      </div>
      <div class="answers-container">
        <button id="choice1" class="choice" onclick="checkAnswer(false, 4)">Fox</button>
        <button id="choice2" class="choice" onclick="checkAnswer(false, 5)">Gorilla</button>
        <button id="choice3" class="choice" onclick="checkAnswer(true, 7)">Hart</button>
        <button id="choice4" class="choice" onclick="checkAnswer(false, 13)">Puma</button>
    </div>
