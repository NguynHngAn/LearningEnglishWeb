...
<body>
  <div class="quiz-container">
    ...
    <br>
    <p class="question">Quả nào dưới đây có tên gọi "Banana"?</p>
    <div class="answers-container">
      <button id="choice1" class="choice" onclick="checkAnswer(true, 20)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_image.php?id=25" alt="Image">
          </div>

      </button>
      <button id="choice2" class="choice" onclick="checkAnswer(false, 11)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice3" class="choice" onclick="checkAnswer(false, 6)">
        <div class="answer-content">
          <div class="answer-image">
      ...
      <button id="choice4" class="choice" onclick="checkAnswer(false, 1)">
        <div class="answer-content">
          <div class="answer-image">
            <img src="retrieve_image.php?id=26" alt="Image">
    ...
    <div id="nextPage" class="hidden">
      <a href="fruit2.php" id="nextButton" class="hidden next-button">Next</a>
    </div>
  </div>
