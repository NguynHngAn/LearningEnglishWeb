...
<body>
    <div class="quiz-container">
      ...
      <br>
      <p class="question">"Bear" là con vật nào dưới đây?</p>
      <div class="answers-container">
        ...
        <button id="choice2" class="choice" onclick="checkAnswer(false, 7)">
          <div class="answer-content">
            <div class="answer-image">
        ...
        <button id="choice4" class="choice" onclick="checkAnswer(true, 19)">
          <div class="answer-content">
            <div class="answer-image">
      ...
      <div id="nextPage" class="hidden">
        <a href="animal9.php" id="nextButton" class="hidden next-button">Next</a>
      </div>
    </div>
